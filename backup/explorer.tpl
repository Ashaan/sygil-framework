...
<head>
  ...
  <link href="http://www.sygil.org/style.css" rel="stylesheet" type="text/css" />
  <script type="text/javascript" src="http://www.sygil.org/script.js"></script>
</head>
<body onload="__ONLOAD__">
  <table id="explorer" class="table">
