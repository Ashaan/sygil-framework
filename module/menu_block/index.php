...
$core->addScriptUrlInit ('url.menu_block_id   = '.(isset($_GET['MenuBlockId'])?$_GET['MenuBlockId']:1).';');
$core->addScriptUrlInit ('url.menu_block_open = '.(isset($_GET['MenuBlockClose'])?0:1).';');
