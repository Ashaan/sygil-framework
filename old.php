...
$tplData = array(
  '__THEME__'       => '<link href="theme/default/style.css" rel="stylesheet" type="text/css" />',
  '__SCRIPT__'      => '<script type="text/javascript" src="script/vrac.js"></script>',
  '__URL_INIT__'    => '', 
  '__URL_READ__'    => '', 
  '__URL_WRITE__'   => '',
...
echo Template::_get('index',$tplData);
