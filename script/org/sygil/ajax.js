registerNamespace('org.sygil.ajax.div')
registerNamespace('org.sygil.ajax');

org.sygil.ajax = function/*org.sygil.ajax*/() {
    return {
        Ajax : function() {
            this.queue = [];
            this.data  = [];
            ...
            this.receive = function(XML, TEXT) {
                ...
                for (var i=0;i<xmlDoc.childNodes.length;i++) {
                    ...
                    if (child.tagName == 'content') {
                        content += org.sygil.base64.decode(child.firstChild.nodeValue);
                    } else
        ...
        open : function(name) {
            var temp = new org.sygil.ajax.Ajax();
        ...
        load : function (name,target,method,param) {
            var temp = new org.sygil.ajax.Ajax();
